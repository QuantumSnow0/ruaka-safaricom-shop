import { BlogPostData, RelatedPost } from "../types/blogPost";

export const sampleBlogPost: BlogPostData = {
  id: 1,
...
*Have you tried any of these tips? Share your success stories in the comments below!*
  `,
  category: "Deals & Savings Hub",
  tags: ["deals", "savings", "promotions", "tips", "safaricom", "bundles"],
  author: "Safaricom Shop Ruaka",
  authorBio:
    "Your trusted local Safaricom partner in Ruaka, helping customers save money and get the best deals for over 5 years.",
  ...
  seoDescription:
    "Discover hidden Safaricom promotions and exclusive deals in Ruaka. Save hundreds of shillings monthly with our insider tips for data bundles and airtime.",
  seoKeywords: [
    "safaricom deals",
    "data bundles kenya",
    "airtime offers",
...
export const relatedPosts: RelatedPost[] = [
  {
    ...
    category: "Deals & Savings Hub",
    image: "/assets/blog/data-bundles.jpg",
    readTime: "6 min read",
  },
  {
    id: 3,
    title: "Bundle Hacks: Maximize Your Data & Airtime",
    slug: "bundle-hacks-maximize-data-airtime",
    category: "Deals & Savings Hub",
    image: "/assets/blog/bundle-hacks.jpg",
    readTime: "5 min read",
  },
  {
    id: 4,
    title: "Safaricom Loyalty Rewards: Unlock Free Benefits",
    slug: "safaricom-loyalty-rewards-free-benefits",
    category: "Deals & Savings Hub",
    image: "/assets/blog/loyalty-rewards.jpg",
    readTime: "7 min read",
  },
];
